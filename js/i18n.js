...
(function () {
    ...
    const translations = {
        en: {
            ...
            'theme.dark': 'Dark',
            'theme.light': 'Light',
            'about.subheading': "B.Sc. in Software Engineering · Junior DevOps Engineer",
            'about.lead':
                'Software Engineering graduate focused on DevOps, Linux, containerization, and infrastructure automation. Hands-on experience with Docker, Kubernetes, Ansible, GitLab CI/CD, and Linux through personal infrastructure projects. Experienced in deploying and managing containerized applications and building automated development and deployment workflows. Also experienced in Solidity development and Web3 security through practical projects and security labs.',
            ...
            'experience.job1.date': '2026 - Present',
            'experience.job2.title': 'Web3 Development & Security',
            ...
            'experience.job2.n4': 'Analyzed and exploited smart contracts to identify vulnerabilities including reentrancy, access control, price manipulation, and logic flaws.',
            'experience.job2.n5': 'Practiced smart contract security through Ethernaut and Damn Vulnerable DeFi challenges, using Slither for static analysis and vulnerability detection.',
            ...
            'experience.job2.date': '2024 - 2025',
            ...
            'education.item1.gpa': '',
            'education.item1.date': '2016 - 2021',
            'education.item2.school': 'Molavi High School',
            'education.item2.degree': 'Diploma in Natural Science',
            'education.item2.gpa': '',
            'education.item2.date': '2011 - 2015',
            'skills.title': 'Skills',
            'skills.tools': 'Tools & Programming Languages',
            'skill1.workflow': 'DevOps & Infrastructure',
            'skill1.item1': 'Kubernetes',
            'skill1.item2': 'Docker, Docker-Compose & Containerization',
            'skill1.item3': 'Linux & Networking',
            'skill1.item4': 'Ansible',
            'skill1.item5': 'Git, GitLab & GitLab CI/CD',
            'skill1.item6': 'Infrastructure Automation',
            'skill1.item7': 'ArgoCD',
            'skill1.item8': 'Monitoring',
            'skill1.item9': 'KVM / libvirt',
            'skill2.workflow': 'Web3 Development & Security',
            'skill2.item1': 'Solidity',
            'skill2.item2': 'Foundry',
            'skill2.item3': 'OpenZeppelin & Chainlink',
            'skill2.item4': 'Smart Contract Security',
            'skill2.item5': 'Ethernaut & Damn Vulnerable DeFi',
            'interests.title': 'Interests',
            'interests.p1':
                'Outside of technology, I enjoy gaming, watching series, exploring new places, learning about different cultures, and staying active through fitness. I also have an interest in cybersecurity and emerging technologies.',
            'interests.p2': 'Technical Interests:',
            ...
            'awards.item1': 'Maktabkhoneh — Git & Github',
